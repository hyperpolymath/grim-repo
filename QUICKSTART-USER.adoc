...
// Replace grim-repo, Grim Repo — See README.adoc for details., just run, Grim Repo started successfully. with actuals
= grim-repo — Quick Start for Users
:toc:
:toclevels: 2

== What is grim-repo?

Grim Repo — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./grim-repo-portable
----
...
[source]
----
Grim Repo started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/grim-repo/wiki
