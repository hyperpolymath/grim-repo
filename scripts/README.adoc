...
|**Repository Control Suite** (v1.0.0)
|

|**GrimGreaser**
|Pure ReScript build system with GreasyFork auto-publish

|**GrimPager**
|Perpetual auto-paging engine with smart detection

|**GrimTemplateEngine**
|Intelligent repository health agent with context-aware templates

|**GrimLicenseChecker**
|License compliance validator with SPDX header detection

|**GrimCIValidator**
|GitHub Actions workflow quality checker

|**GrimSecurityScanner**
|Security vulnerability detector for repositories
...
MPL-2.0 OR Palimpsest-0.5 (dual licensed)

See link:LICENSE.txt[LICENSE.txt] for details.

== Contributing

Contributions welcome! Please read link:../.github/CONTRIBUTING.md[CONTRIBUTING.md] first.
